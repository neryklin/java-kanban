...
@Deprecated
public class FileBackedSyncronizedTaskManager extends InMemoryTaskManager implements TaskManager {
    final String pathToSave;

    public FileBackedSyncronizedTaskManager(String pathToSave) {
